...
<body>
	...
	<div class="content">
		<h1>게시판-수정하기</h1>
		<form name="boardUpdateForm" action="/board_update" 
			...
			<ul>
				...
				<li>
					...
					<!-- JSTL의 if는 조건이 단 하나로 체크될 경우 사용, 
					조건이 여러개로 체크될 경우 choose/when으로 사용 -->
					<c:choose>
					...
					<!-- choose로 감싸고 안에 when/otherwise로 사용(if~else와 같음) -->
				</li>
				<li>
					...
					<a href="/${rpage} "><button type="button" class="btn_style">리스트</button></a>
				</li>
			</ul>
		</form>
